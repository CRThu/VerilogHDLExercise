...
HD_PWD='D:/Code/Vivado/VerilogHDLExercise/mux4_to_1/mux4_to_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux4_to_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux4_to_1.tcl
