...
HD_PWD='D:/Code/Vivado/VerilogHDLExercise/ripple_carry_counter/ripple_carry_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ripple_carry_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ripple_carry_counter.tcl
